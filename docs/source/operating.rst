[ankurgpt-71b9] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [ankurgpt-71b9] container is NOT running**.

.. tip::
   You must have your [ankurgpt-71b9] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/AnkurPokhrel8/raspberryCYT180/blob/main/tml-airflow/logs/logs.txt
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/AnkurPokhrel8/raspberryCYT180  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=38777  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='AnkurPokhrel8'  \-\-env DOCKERUSERNAME='pokhrelankur8@gmail.com'  \-\-env MQTTUSERNAME='GyanRaj8'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   pokhrelankur8@gmail.com/ankurgpt-71b9-amd64 (https://hub.docker.com/r/pokhrelankur8@gmail.com/ankurgpt-71b9-amd64)
...
.. important::
   docker run -d -p 56539:56539 -p 41161:41161 -p 56181:56181 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=ankurgpt-71b9 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-ankurgpt-71b9 \-\-env GITUSERNAME=AnkurPokhrel8  \-\-env GITREPOURL=https://github.com/AnkurPokhrel8/raspberryCYT180 \-\-env SOLUTIONEXTERNALPORT=56539  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=41161  \-\-env SOLUTIONVIPERVIZPORT=56181 \-\-env DOCKERUSERNAME='pokhrelankur8@gmail.com' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=38777 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='GyanRaj8' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  pokhrelankur8@gmail.com/ankurgpt-71b9-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - pokhrelankur8@gmail.com/ankurgpt-71b9-amd64
...
[ankurgpt-71b9] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/AnkurPokhrel8/raspberryCYT180/tree/main/tml-airflow/dags/tml-solutions/ankurgpt-71b9
...
.. important::
   https://ankurgpt-71b9.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-ankurgpt-71b9
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=56539, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=36429, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=39765, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=42539, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=37881, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=38207, HPDEHOST=127.0.1.1, HPDEPORT=32819, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=40373

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-7191-ankurgpt-71b9,solution_preprocessing_ai_mqtt_dag-ankurgpt-71b9, python-preprocess-7488-ankurgpt-71b9,solution_preprocessing_ai_mqtt_dag-ankurgpt-71b9, python-ai-6167-ankurgpt-71b9,solution_preprocessing_ai_mqtt_dag-ankurgpt-71b9, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
